    ...
    this.state = {
      entries: [
        ...
        },
        {
          ...
          description:
            'The Monarch is a member of the Milkweed family famed for its multi-generational migrations.',
        ...
        },
        {
          ...
          familyName: 'Nymphalidae',
          description:
            'The Mourning Cloak is a large brown butterfly with yellow fringes on its wings.',
